...
<div class="container" style='margin-top:90px; margin-bottom: 90px'>
    <div class="row">
        <div class="mt-5 col-12">
            ...
            <p class="desc">Adapun daftar pegawai yang telah dievaluasi pada tahun sebelumnya dapat dilihat pada tabel
                berikut: </p><br>
                ...
                foreach ($hasil as $hasil) {
                    ...
                    <tr>
                        ...
                        <td><?php
                            ...
                            ?></td>
                        <td>
                            <a href="/proses/delete_data.php?nama=<?php echo $hasil['nama_pegawai']; ?>&usia=<?php echo $hasil['usia']; ?>&mk=<?php echo $hasil['masa_kerja']; ?>">
